...
perpendicular to the direction of the motion. We will show through experimental
validation that our fiducial works better than popular fiducials such as
ARTag under signifacant motion blur.
...
\begin{figure}
 ...
 \begin{subfigure}[b]{0.19\textwidth}
  ...
  %\includegraphics[width=0.5\linewidth]{newconcentric_10.pdf}
