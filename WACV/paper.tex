...
%\captionof{table}{Recognition rate of ARTag and Pi-tag fiducial marker atvarious blur scales}
...
\begin{figure}
\centering
  \includegraphics[width=.24\linewidth]{newconcentric_00.pdf}
  \includegraphics[width=.24\linewidth]{newconcentric_01.pdf}
  \includegraphics[width=.24\linewidth]{newconcentric_10.pdf}
  \includegraphics[width=.24\linewidth]{newconcentric_11.pdf}
...
%Video clips of collected data are provided in the supplementary material.
...
\includegraphics[width=\linewidth]{setup_artag/output_79.jpg}
\end{subfigure}
\begin{subfigure}[b]{.19\textwidth}
\includegraphics[width=\linewidth]{setup_artag/output_150.jpg}
\end{subfigure}
\begin{subfigure}[b]{.19\textwidth}
\includegraphics[width=\linewidth]{setup_artag/output_194.jpg}
\end{subfigure}
\begin{subfigure}[b]{.19\textwidth}
\includegraphics[width=\linewidth]{setup_artag/output_339.jpg}
\end{subfigure}
\begin{subfigure}[b]{.19\textwidth}
\includegraphics[width=\linewidth]{setup_artag/output_480.jpg}
\end{subfigure}\\
\begin{subfigure}[b]{.19\textwidth}
\includegraphics[width=\linewidth]{setup_our/output_6/output_514.jpg}
\end{subfigure}
\begin{subfigure}[b]{.19\textwidth}
\includegraphics[width=\linewidth]{setup_our/output_2/output_64.jpg}
\end{subfigure}
\begin{subfigure}[b]{.19\textwidth}
